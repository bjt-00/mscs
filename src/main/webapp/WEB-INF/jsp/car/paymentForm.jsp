    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body">
		<form id="frmPayment" action="${pageContext.request.contextPath}/payment/byCash" method="post">
			...
			<input name="reservationId" id ="reservationId" type="hidden" value="${payment.reservationId}">
 		 <div class="row">
			<div class="col-lg-12">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse3" class="panel-collapse collapse">
      <div class="panel-body">
  		 ...
  		 <div class="row">
			<div class="col-lg-12">
			      <a class="btn btn-default clsPaynow paypaylink" style="font-family:verdana;color:#ffffff;background-color:orange;font-size:14px;padding-left:5px;padding-right:5px;border:1px solid #e1e1e1;" 
			      href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=DNB4QB9XHGYJ2&lc=AE&item_name=CRS : Car Reservation System&amount=${payment.amountPayable}&no_note=1&cn=Add%20special%20instructions%20to%20the%20seller%3a&no_shipping=1&rm=1&return=http%3a%2f%2fwww%2ethesuffah%2eorg%2fsuccess&cancel_return=http%3a%2f%2fwww%2ethesuffah%2eorg%2fcancel&currency_code=USD&bn=PP%2dDonationsBF%3abug_rollover%2epng%3aNonHosted" 
			      target="_new" title="PayPal payment" data-murl="${pageContext.request.contextPath}/payment/byPaypal" > Pay Now </a>
			</div>	
		</div>
